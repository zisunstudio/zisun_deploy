...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    "- Shipping is free across India on every order.",
    `- Dispatched in ${POLICY_TERMS.dispatchTimeframe}. Size exchange within ${POLICY_TERMS.exchangeRaiseWindowHours} hours of delivery; no returns (see ${SITE_URL}/refund).`,
